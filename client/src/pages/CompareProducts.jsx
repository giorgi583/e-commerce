...
const getProduct = async () => {
  ...
  return (
    ...
    <div className='max-w-7xl mx-auto py-15 px-10'>
      ...
      <div className='grid grid-cols-3 max-lg:grid-cols-1 border border-gray-300 rounded-lg shadow-lg'>
        <div className='flex flex-col gap-1 rounded-lg'>
          <h3 className='text-xl font-semibold bg-indigo-500 p-2 text-white rounded-tl-lg'>Name</h3>
          <p className='bg-amber-50 p-2'>Price</p>
          <p className='bg-indigo-50 p-2'>Category</p>
          <p className='h-15 bg-amber-50 p-2'>Description</p>
        ...
        <div className='flex flex-col gap-1 rounded-lg'>
          <h3 className='text-xl font-semibold bg-indigo-500 p-2 text-white'>{product1.name}</h3>
          <p className='bg-amber-50 p-2'>${product1.discountedPrice || product1.price}</p>
          <p className='bg-indigo-50 p-2'>{product1.category}</p>
          <p className='h-15 bg-amber-50 p-2'>{product1.description}</p>
        ...
        <div className='flex flex-col gap-1 rounded-lg'>
          <h3 className='text-xl font-semibold bg-indigo-500 p-2 text-white rounded-tr-lg'>{product2.name}</h3>
          <p className='bg-amber-50 p-2'>${product2.discountedPrice || product2.price}</p>
          <p className='bg-indigo-50 p-2'>{product2.category}</p>
          <p className='h-15 bg-amber-50 p-2'>{product2.description}</p>
